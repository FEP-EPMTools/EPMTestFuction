...
uint32_t _trace_level = TRACE_LEVEL_ALL;//TRACE_LEVEL_WARNING;
uint32_t _trace_modules = TRACE_MODULE_ALL;//TRACE_MODULE_NONE;
uint32_t _trace_functions = TRACE_FUNCTION_ALL;//TRACE_FUNCTION_NONE;
