...
/*-----------------------------------------*/
#define MTP232_COMM_UART  UART_0_INTERFACE_INDEX
...
{
    //terninalPrintf("LoraDrvInit!!\r\n");
    sysprintf("LoraDrvInit!!\n");
    pUartInterface = UartGetInterface(MTP232_COMM_UART);
    if(pUartInterface == NULL)
    {
        //terninalPrintf("LoraDrvInit ERROR (pUartInterface == NULL)!!\r\n");
    ...
    {
        //terninalPrintf("LoraDrvInit ERROR (initFunc false)!!\r\n");
