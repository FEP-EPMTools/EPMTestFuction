...
#define FTP_DEL_FIL_FRONT          "AT+QFTPDEL=\""
#define FTP_DEL_FIL_END            "\"\r\n"

/*
#define str(strx,stry,strz)        #strx#stry#strz
#define FTP_DELETE_FILE(name)      str(FTP_DEL_FIL_FRONT,name,FTP_DEL_FIL_END)   //str(FTP_DEL_FIL_FRONT)   //###name##str(FTP_DEL_FIL_END)  //"AT+QFTPDEL=\"#name\"\r\n"          
*/
