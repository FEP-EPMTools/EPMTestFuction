...
{  
    ...
    */
    ...
    if (s32_ret == ERR_NOERR) {
        ...
        //DbgDump((uint8_t *)DeviceV.Reserved, sizeof(DeviceV.Reserved)); 
        return TRUE;
    } 
    else
    {
...
BOOL OctopusReaderInit(void)
{
    ...
    {
        terninalPrintf("OctopusReaderInit ERROR (initFunc false)!!\r\n");
    ...
    terninalPrintf("OctopusReaderInit OK!!!\r\n");
