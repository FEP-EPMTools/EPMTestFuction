...
/*-----------------------------------------*/
//|-------------  RAW:3MB  ------------------|//
//|-- RECORD:2MB --|-- STORAGE: 16k--|--??---|//
    
//RECORD DATA
#define SFLASH_RECORD_PAGE_SIZE_PER_RECORD  8 //page per record
...
#define SFLASH_RECORD_TOTAL_PAGE_SIZE       8192  //use how many page, max value: SPI_FLASH_EX_RAW_PAGE_SIZE
#define SFLASH_RECORD_LAST_PAGE             (SFLASH_RECORD_START_PAGE + SFLASH_RECORD_TOTAL_PAGE_SIZE - 1)   //最後 page

#define SFLASH_RECORD_TOTAL_NUM             (SFLASH_RECORD_TOTAL_PAGE_SIZE / SFLASH_RECORD_PAGE_SIZE_PER_RECORD)  //可以有幾筆 record: 8192/8 = 1000
#define SFLASH_RECORD_SIZE                  (SPI_FLASH_EX_PAGE_SIZE * SFLASH_RECORD_PAGE_SIZE_PER_RECORD) //每筆record大小: 256*8 = 2048byte
