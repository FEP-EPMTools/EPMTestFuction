...
typedef enum{
    ...
    EPD_PICT_CONTAIN_SELECT_TIME_CAST_BG_INDEX = 140,
    //EPD_PICT_CONTAIN_BG_6_INDEX = 141,
    //EPD_PICT_BOARD_L_INDEX = 142,
    //EPD_PICT_BOARD_R_INDEX = 143,
    //EPD_PICT_BOARD_I_L_INDEX = 144,
    //EPD_PICT_BOARD_I_R_INDEX = 145,
    EPD_PICT_CONTAIN_READER_INIT_INDEX = 146,    
    EPD_PICT_CONTAIN_READER_INIT_FAIL_INDEX = 147,    
    EPD_PICT_CONTAIN_DEPOSIT_INDEX = 148,    
    EPD_PICT_CONTAIN_DEPOSIT_OK_INDEX = 149,    
    EPD_PICT_CONTAIN_DEPOSIT_FAIL_INDEX = 150,   
    EPD_PICT_CONTAIN_MOBILE_PAY_INDEX = 151, 
...
//    EPD_PICT_CONTAIN_BG_2_1_INDEX = 164,
    ...
    EPD_PICT_KEY_QRCODE	= 245,
    EPD_PICT_KEY_CARD		= 246,
    */
    EPD_PICT_KEY_CLEAN_BAR  = 239,
    EPD_PICT_KEY_CONFIRM	= 240,
    EPD_PICT_KEY_RIGHT		= 241,
    EPD_PICT_KEY_ONE        = 242,
    EPD_PICT_KEY_TWO        = 243,
    EPD_PICT_KEY_THREE      = 244,
    EPD_PICT_KEY_FOUR       = 245,
    EPD_PICT_KEY_FIVE       = 246,
    EPD_PICT_KEY_SIX        = 247,
}epdPictIndex; 
