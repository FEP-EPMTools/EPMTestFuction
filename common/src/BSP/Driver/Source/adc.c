...
* $Revision: 6 $
* $Date: 15/05/18 5:45p $
* @brief    NUC970 ADC driver source file
*
* @note
...
/** @addtogroup NUC970_ADC_Driver ADC Driver
  @{
*/

/** @addtogroup NUC970_ADC_EXPORTED_FUNCTIONS ADC Exported Functions
  @{
*/
/// @cond HIDDEN_SYMBOLS
...
INT adcOpen(void)
{
    ...
    outpw(REG_CLK_DIVCTL7, inpw(REG_CLK_DIVCTL7) & ~((0x3<<19)|(0x7<<16)));
    outpw(REG_CLK_DIVCTL7, (0x0<<19)|(11<<16));
    ...
    /* Set interrupt */
    sysSetInterruptType(ADC_IRQn, HIGH_LEVEL_SENSITIVE);
...
/*@}*/ /* end of group NUC970_ADC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC970_ADC_Driver */
