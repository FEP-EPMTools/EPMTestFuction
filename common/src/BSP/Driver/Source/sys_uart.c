...
INT  sysIsKbHit()
{
    //terninalPrintf("sysIsKbHit\n");
    //terninalPrintf("FSR=%d  \n",inpw(REG_UART0_FSR));
...
static BOOL justTerminalPrintfFlag = FALSE;
void setPrintfFlag(BOOL flag)
{
    justTerminalPrintfFlag = flag;
}
/**
 ...
 *  @return   None
 */
void terninalPrintf(PINT8 pcStr,...)
{
    INT8  *argP;
