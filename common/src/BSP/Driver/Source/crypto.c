...
/** @addtogroup NUC970_CRYPTO_Driver CRYPTO Driver
  @{
*/


/** @addtogroup NUC970_CRYPTO_EXPORTED_FUNCTIONS CRYPTO Exported Functions
  @{
*/
...
{
    *(uint32_t *)((uint32_t)&CRPT->TDES0_IVH + 0x40 * u32Channel) = u32IVH; // ((u32IVH<<24)&0xff000000) | ((u32IVH<<8) & 0x00ff0000) | ((u32IVH>>8) & 0x0000ff00) | ((u32IVH>>24) & 0x000000ff);
    *(uint32_t *)((uint32_t)&CRPT->TDES0_IVL + 0x40 * u32Channel) = u32IVL; //  ((u32IVL<<24)&0xff000000) | ((u32IVL<<8) & 0x00ff0000) | ((u32IVL>>8) & 0x0000ff00) | ((u32IVL>>24) & 0x000000ff);
}
...
/*@}*/ /* end of group NUC970_CRYPTO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC970_CRYPTO_Driver */
