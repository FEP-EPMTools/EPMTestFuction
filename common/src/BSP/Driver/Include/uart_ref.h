...
* @version  V1.00
* $Revision: 5 $
* $Date: 15/06/10 12:00p $
* @brief    NUC970 UART driver header file
*
* @note
...
#define UARTWRITESIZE    (1024+256)//by sam 100 /*!< UART max. write size */
...
#define UARTA       10   /*!< UART10  channel */
...
/*---------------------------------------------------------------------------------------------------------*/
#define DATA_BITS_5     (0) /*!< UA_LCR setting to set UART word length to 5 bits */
#define DATA_BITS_6     (1) /*!< UA_LCR setting to set UART word length to 6 bits */
#define DATA_BITS_7     (2) /*!< UA_LCR setting to set UART word length to 7 bits */
#define DATA_BITS_8     (3) /*!< UA_LCR setting to set UART word length to 8 bits */

#define PARITY_NONE    (0x0 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as no parity   */
#define PARITY_ODD     (0x1 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as odd parity  */
#define PARITY_EVEN    (0x3 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as even parity */
#define PARITY_STICK    (0x8 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as stick parity */

#define STOP_BITS_1     (0x0 << UART_LCR_NSB_Pos) /*!< UA_LCR setting for one stop bit  */
#define STOP_BITS_1_5   (0x1 << UART_LCR_NSB_Pos) /*!< UA_LCR setting for 1.5 stop bit when 5-bit word length  */
#define STOP_BITS_2     (0x1 << UART_LCR_NSB_Pos) /*!< UA_LCR setting for two stop bit when 6, 7, 8-bit word length */
...
/** @addtogroup NUC970_UART_EXPORTED_STRUCTS UART Exported Structs
  @{
*/
